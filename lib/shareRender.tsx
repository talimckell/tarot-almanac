...
import { COLORS } from "./shareTokens";

export const WIDTH = 1200;
export const HEIGHT = 630;

// Palette + element mapping live in lib/shareTokens.ts (pure, no Node deps) so the
// Remotion video compositions in /remotion can share them; re-exported here so every
// existing consumer keeps importing from shareRender unchanged.
export { COLORS, elementColor } from "./shareTokens";
export type { ElementName } from "./shareTokens";
